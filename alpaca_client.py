...
class AlpacaClient:
    ...
    def get_bars(self, symbol: str, timeframe: str = '1Day', limit: int = 35) -> List[Dict]:
        ...
        if is_crypto:
            ...
            # self.data_base_url (not the module-level DATA_BASE_URL) so a per-instance
            # override works -- needed by dashboard/readonly_client.py, which constructs
            # one AlpacaClient per Alpaca account in the same process.
            base_url = (
