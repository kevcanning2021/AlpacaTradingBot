...
def _make_response(decision_dict, stop_reason='end_turn', extra_blocks=None, stop_details=None):
    ...
    # response.usage.input_tokens/.output_tokens must be real ints, not an
    # unconfigured MagicMock -- agents/research_agent.py's usage logging
    # (added 2026-08-28, after this test file was originally written on
    # origin/master) reads them and writes them into the audit trail JSON,
    # which fails to serialize a bare MagicMock.
